...
const GALLERY_ITEMS: GalleryItem[] = [
  {
    ...
    description: 'Holding hands under the golden streetlights, whispering secrets.',
    date: 'June 4, 2026',
  ...
  {
    id: 'g2',
    title: 'Cozy Café Dates',
    description: 'Shared warm coffee, endless smiles, and stealing quick glances.',
    date: 'June 9, 2026',
  ...
  },
  {
    ...
    description: 'Cozy indoors listening to the raindrops play a beautiful melody.',
    date: 'June 19, 2026',
